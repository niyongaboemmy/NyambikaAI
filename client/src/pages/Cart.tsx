...
import { Trash2, Plus, Minus, ShoppingBag, CreditCard, Smartphone } from 'lucide-react';
  ...
  const [cartItems, setCartItems] = useState([
    {
      ...
      description: 'Lightweight cotton blend',
      price: 45000,
      quantity: 1,
      size: 'M',
    ...
    },
    {
      ...
      description: 'Premium leather with gold accents',
      price: 65000,
      quantity: 1,
      size: 'One Size',
          ...
          {cartItems.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <Link href="/products">
                  <Button variant="ghost" className="w-full glassmorphism py-4 rounded-xl hover:scale-105 transition-all duration-300 font-semibold">
                    Komeza Guhitamo / Continue Shopping
                  </Button>
                </Link>
              </div>
