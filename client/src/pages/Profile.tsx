...
export default function Profile() {
  ...
  const isPageLoading = !user || favoritesLoading || ordersLoading || tryOnLoading;
          ...
          <div className="flex flex-col lg:flex-row gap-3 sm:gap-4">
            ...
            <div className="flex-1 space-y-3 sm:space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="bg-white/70 dark:bg-gray-900/60 rounded-xl border border-gray-200/60 dark:border-gray-800 p-3">
            ...
            <div className="lg:w-80 space-y-3">
              ...
              <div className="bg-white/70 dark:bg-gray-900/60 rounded-xl border border-gray-200/60 dark:border-gray-800 p-3 space-y-2">
                ...
                {[...Array(2)].map((_, i) => (
                  <div key={i} className="p-3 rounded-lg bg-gray-50 dark:bg-gray-800/60">
