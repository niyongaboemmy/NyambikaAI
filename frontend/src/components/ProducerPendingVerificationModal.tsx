...
export default function ProducerPendingVerificationModal({
  ...
  return (
    ...
    >
      ...
      <DialogContent
        className="p-0 overflow-hidden border border-slate-200/50 dark:border-slate-700/50 max-h-[95vh] rounded-3xl bg-white dark:bg-gray-900"
        hideClose
      >
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-6 space-y-4">
            <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
              <li className="flex items-start gap-2">
                <span className="mt-1 h-2 w-2 rounded-full bg-gold-500 animate-pulse" />
          ...
          <div className="mt-8 flex justify-end">
            <Button
              className="text-white rounded-xl transition-all duration-300 hover:scale-105 bg-gold-600 hover:bg-gold-700"
              onClick={() => {
                logout();
                router.push("/");
              }}
