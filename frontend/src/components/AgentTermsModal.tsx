  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4">
      ...
      <div className="relative w-full max-w-2xl rounded-3xl border border-white/10 bg-white/80 dark:bg-gray-900/80 shadow-2xl backdrop-blur-xl overflow-hidden flex flex-col max-h-[99vh]">
        ...
        <div className="sticky top-0 z-10 px-4 sm:px-8 pt-4 pb-3 sm:pt-6 sm:pb-4 bg-gradient-to-r from-blue-500/20 via-blue-500/10 to-blue-500/20 border-b border-white/10">
          <div className="flex flex-col md:flex-row md:items-center gap-3">
            <div className="hidden md:inline-block h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-gradient-to-tr from-blue-500 to-blue-700 animate-pulse" />
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-3 overflow-y-auto space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="p-3 rounded-3xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20">
              <div className="text-sm font-medium">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            onClick={accept}
            className="w-full sm:w-auto inline-flex justify-center items-center rounded-full bg-gradient-to-r from-blue-600 to-blue-400 px-5 py-3 text-sm font-medium text-white shadow hover:from-blue-600 hover:to-blue-600 disabled:opacity-60"
          >
