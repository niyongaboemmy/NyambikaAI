      ...
      <div className="relative w-full max-w-2xl rounded-3xl border border-white/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl overflow-hidden flex flex-col max-h-[99vh]">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            onClick={accept}
            className="w-full sm:w-auto inline-flex justify-center items-center rounded-full px-5 py-3 text-sm font-medium text-white disabled:opacity-60 bg-gold-600 hover:bg-gold-600"
          >
