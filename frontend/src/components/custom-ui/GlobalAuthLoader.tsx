  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-full blur-2xl animate-pulse delay-1000"></div>
