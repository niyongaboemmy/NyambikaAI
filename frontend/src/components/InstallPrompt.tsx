      ...
      case "ios":
        return (
          <div className="space-y-2.5 sm:space-y-3">
            <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-1.5">
            ...
            <ol className="space-y-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
              <li className="flex gap-2 items-start p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                <span className="flex-shrink-0 w-5 h-5 flex items-center justify-center rounded-full text-white text-[10px] font-bold bg-gold-500">
                  1
                </span>
    ...
    <>
      ...
      {!showInstructions && (
        <div className="fixed bottom-4 right-4 z-50 max-w-[calc(100vw-2rem)] sm:max-w-sm animate-in slide-in-from-bottom-5 fade-in duration-500">
          <div className="group relative overflow-hidden rounded-3xl backdrop-blur-xl bg-white/90 dark:bg-gray-900/90 border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300">
            {/* Animated gradient background */}
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gray-500/5" />
            <div className="absolute -inset-1 blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-300 -z-10 bg-gray-500/20" />
            ...
            <div className="relative p-3 sm:p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-shrink-0 w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 bg-gold-500">
              ...
              <div className="flex gap-2 mt-3">
                {isInstallable && deferredPrompt ? (
                  ...
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-full text-white text-xs sm:text-sm font-medium focus:outline-none focus:ring-2 focus:ring-gold-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95 bg-gold-500 hover:bg-gold-600"
                  >
                    {isInstalling ? (
                      <>
                  ...
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-full text-white text-xs sm:text-sm font-medium focus:outline-none focus:ring-2 focus:ring-gold-500 transition-all active:scale-95 bg-gold-500 hover:bg-gold-600"
                  >
                    <Download className="h-3.5 w-3.5" />
                    <span>Get App</span>
                  </button>
            ...
            {isInstalling && (
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gray-200 dark:bg-gray-800 overflow-hidden">
                <div
                  className="h-full animate-[shimmer_1.5s_ease-in-out_infinite] bg-gold-500"
                  style={{ width: "40%" }}
                />
              </div>
            )}
      ...
      {showInstructions && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-3 sm:p-4 animate-in fade-in duration-300">
          ...
          <div className="relative bg-white dark:bg-gray-900 rounded-3xl max-w-md w-full overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-5 duration-300">
            ...
            <div className="relative p-4 sm:p-5 text-white overflow-hidden bg-gold-500">
            ...
            <div className="p-4 sm:p-5 max-h-[60vh] overflow-y-auto">
              ...
              <div className="mb-4 p-3 sm:p-4 rounded-xl border border-gray-200 dark:border-gray-700/30 bg-gold-50 dark:bg-gray-900/20">
                <h4 className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <Download className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-800" />
                  Why install?
                </h4>
              ...
              {platform === "ios" && !isSafari() && (
                <div className="mt-3 p-2.5 sm:p-3 bg-gray-50/50 dark:bg-gray-800/20 rounded-lg border border-gray-200 dark:border-gray-700/30">
                  <p className="text-xs text-black dark:text-gray-200 flex items-start gap-2">
                    <Info className="h-4 w-4 text-gray-800 shrink-0" />
                    <span>
            ...
            <div className="px-4 sm:px-5 py-3 sm:py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700/50 flex gap-2 sm:gap-3">
              ...
              {isInstallable && deferredPrompt && (
                <button
                  onClick={handleInstall}
                  disabled={isInstalling}
                  className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 sm:px-4 py-2 rounded-lg text-white text-xs sm:text-sm font-medium focus:outline-none focus:ring-2 focus:ring-gold-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95 bg-gold-500 hover:bg-gold-600"
                >
                  {isInstalling ? (
                    <>
                      <div className="h-3.5 w-3.5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
