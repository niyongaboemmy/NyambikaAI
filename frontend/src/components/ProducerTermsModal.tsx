...
export default function ProducerTermsModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4">
      ...
      <div className="relative w-full max-w-2xl rounded-3xl border border-white/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl overflow-hidden flex flex-col max-h-[99vh]">
        <div className="sticky top-0 z-10 px-4 sm:px-8 pt-4 pb-3 sm:pt-6 sm:pb-4 border-b border-white/10 bg-gray-500/20">
          <div className="flex flex-col md:flex-row md:items-center gap-3">
            <div className="hidden md:inline-block h-8 w-8 sm:h-10 sm:w-10 rounded-full animate-pulse bg-gold-500" />
              ...
              {[
                ...
                <button
                  ...
                  className={`px-2.5 py-1.5 text-xs sm:text-[11px] rounded-md border transition-colors ${
                    language === l.code
                      ? "bg-white/70 dark:bg-gray-800/70 border-gray-400 text-gray-900 dark:text-gray-300"
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-3 overflow-y-auto space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3 rounded-3xl border border-gray-400/20 bg-gray-500/10">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            onClick={accept}
            className="w-full sm:w-auto inline-flex justify-center items-center rounded-full px-5 py-3 text-sm font-medium text-white disabled:opacity-60 bg-gold-600 hover:bg-gold-500"
          >
