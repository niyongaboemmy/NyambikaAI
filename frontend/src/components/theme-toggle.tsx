...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full bg-gray-500/10 dark:bg-gray-400/10" />
      ...
      {theme === "system" && (
        <div className="absolute -bottom-0.5 -right-0.5 w-2 h-2 rounded-full animate-pulse bg-gold-500" />
      )}
