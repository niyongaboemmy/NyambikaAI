        ...
        <div className="w-full max-w-6xl mx-auto">
          <Card className="border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardHeader className="text-center space-y-4">
              <div className="mx-auto w-16 h-16 rounded-full flex items-center justify-center bg-gold-300">
                <UserCheck className="h-8 w-8 text-white" />
              </div>
              <CardTitle className="text-2xl font-bold to-red-600 text-foreground">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-center gap-4 pt-4 border-t">
                ...
                <Button
                  ...
                  className="text-white bg-gold-300 hover:bg-gold-300"
                  size="lg"
                >
                  {subscriptionLoading ? (
                    <>
