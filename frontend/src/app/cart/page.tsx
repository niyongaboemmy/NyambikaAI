  ...
  return (
    <div className="min-h-screen pt-6 md:pt-3 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gold-500/5 dark:bg-gold-500/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gold-500/5 dark:bg-gold-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gold-500/3 dark:bg-gold-500/5 rounded-full blur-2xl animate-pulse delay-500" />
      </div>

      <main className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        {/* Compact Header */}
        <div className="text-center mb-3 sm:mb-3">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full backdrop-blur-sm border border-gray-200/50 dark:border-white/10 mb-2 bg-gray-500/10 dark:bg-gray-500/20">
            <Zap className="w-3 h-3 sm:w-4 sm:h-4 text-gray-900 dark:text-white" />
            <span className="text-xs sm:text-sm text-gray-700 dark:text-white/80">
              {t("cart.aiBadge")}
            </span>
            <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-gray-900 dark:text-white" />
          </div>
          <h1 className="text-xl sm:text-2xl lg:text-2xl font-bold text-foreground">
            {t("cart.title")}
          </h1>
        </div>
        ...
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 sm:py-16 px-4">
            <div className="relative">
              <div className="absolute inset-0 rounded-full blur-xl bg-gray-500/15 dark:bg-gray-500/20" />
              <ShoppingBag className="relative w-16 h-16 sm:w-20 sm:h-20 text-gray-900 dark:text-white mb-4 sm:mb-6" />
            </div>
            ...
            <Link href="/products">
              <Button className="text-white px-6 sm:px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 text-sm sm:text-base bg-gold-500 hover:bg-gold-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-4">
              {cartItems.map((item, index) => (
                <Card
                  ...
                  className="bg-white/80 dark:bg-white/5 backdrop-blur-sm border-none rounded-xl sm:rounded-2xl p-3 sm:p-4 hover:bg-white/90 dark:hover:bg-white/10 transition-all duration-300"
                  style={{ marginTop: "8px" }}
                >
            ...
            <Card className="backdrop-blur-sm border border-gray-200/50 dark:border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 bg-white/90 dark:bg-white/10">
              <div className="flex items-center justify-between mb-1 sm:mb-2">
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-gray-900 dark:text-white" />
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link href="/checkout" className="flex-1">
                  <Button className="w-full text-white py-3 sm:py-4 rounded-full font-semibold text-base sm:text-sm transition-all duration-300 transform hover:scale-105 bg-gold-500 hover:bg-gold-600">
