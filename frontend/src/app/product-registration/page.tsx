      ...
      <main className="pt-8 md:pt-10 pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          {(subLoading || plansLoading || productsLoading) && (
            <div className="rounded-2xl border border-gray-200/20 bg-gold-500/10 p-6 text-gray-400">
              {t("loading")}
            </div>
          )}
            ...
            !subStatus.hasActiveSubscription && (
              <div className="rounded-2xl border border-amber-200/20 bg-amber-500/10 p-6 text-amber-100 mb-6">
                ...
                <button
                  ...
                  className="mt-4 inline-flex items-center rounded-xl px-4 py-2 text-white hover:opacity-90 bg-gold-500"
                >
          ...
          (myProducts as any[]).length >= currentPlanMaxProducts ? (
            <div className="rounded-2xl border border-red-200/20 bg-red-500/10 p-6 text-red-100">
              ...
              <div className="mt-4 flex gap-3">
                <button
                  onClick={() => router.push("/producer-subscription")}
                  className="inline-flex items-center rounded-xl px-4 py-2 text-white hover:opacity-90 bg-gold-500"
                >
                  {t("upgradePlan")}
                </button>
                <button
