...
export default function SubscriptionRenewal() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <Card className="w-96">
          <CardContent className="pt-6">
            <div className="text-center">
              <CheckCircle2 className="mx-auto h-12 w-12 text-gray-800 mb-4" />
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
                Payment Successful!
              </h3>
              <p className="text-gray-500 dark:text-gray-400 mb-4">
                {producer.name}'s subscription has been renewed. You've earned{" "}
                {(paymentData.amount * 0.4).toLocaleString()} RWF commission.
              </p>
  ...
  const commissionAmount = paymentData.amount * 0.4;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full flex items-center justify-center text-white font-bold text-lg bg-gold-500">
                {producer.name
                  .split(" ")
                  .map((n) => n[0])
                  .join("")}
                  ...
                  <Badge
                    className={
                      producer.subscriptionStatus === "expired"
                        ...
                        : "bg-gray-100 text-black dark:bg-gold-900 dark:text-gray-200"
                    }
                  >
                    {producer.subscriptionStatus === "expired"
                      ? "Expired"
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handlePaymentSubmit} className="space-y-6">
                      ...
                      return (
                        <div
                          ...
                          className={`p-2.5 border rounded-lg cursor-pointer transition-all duration-200 ${
                            selected
                              ? "border-gray-400 bg-gray-50 dark:bg-gray-800/20 ring-2 ring-gold-200 dark:ring-gold-800"
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 ml-5 truncate">
                                {pl.description}
                              </div>
                            </div>
              ...
              <Button
                type="submit"
                className="w-full text-white bg-gold-600 hover:bg-gold-700"
