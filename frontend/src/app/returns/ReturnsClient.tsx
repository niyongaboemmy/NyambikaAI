    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="pblue dark:pblue-invert">
        <section className="mb-12">
          ...
          <div className="bg-gray-50 dark:bg-gray-800/20 border-l-4 border-gray-400 p-4 my-6">
            <div className="flex">
          ...
          <ul className="space-y-3 text-gray-600 dark:text-gray-300">
            {['processingTime', 'refunds', 'confirmation'].map((item) => (
              <li key={item} className="flex items-start">
                <svg className="h-5 w-5 text-gray-800 mr-2 mt-0.5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <section className="bg-gray-50 dark:bg-gray-800/20 p-6 rounded-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a 
              href="/contact" 
              className="inline-flex items-center justify-center px-4 py-2 bg-gold-600 text-white rounded-md hover:bg-gold-700 transition-colors"
            >
