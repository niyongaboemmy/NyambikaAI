...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-gray-200 to-white dark:from-black dark:via-gray-500/5 dark:to-black relative overflow-hidden pt-8">
