      ...
      <div className="text-center">
        ...
        <div className="relative mb-8">
          <div className="w-20 h-20 mx-auto relative">
            ...
            <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-gradient-to-r from-green-400 to-blue-500 rounded-full animate-bounce" style={{ animationDelay: "0.5s" }} />
            <Sparkles className="absolute -top-1 -left-1 h-3 w-3 text-purple-400 animate-pulse" style={{ animationDelay: "1s" }} />
            <Zap className="absolute -bottom-1 -right-1 h-3 w-3 text-yellow-400 animate-pulse" style={{ animationDelay: "1.5s" }} />
          </div>
        </div>
